	...
	public class DailyChallengeSystem : ModSystem
	{
		...
		private static void GenerateChallenge(int seed)
		{
			...
			switch (challengeType)
			{
				case 0:
					dailyKillTarget = 20;
					dailyChallengeDescription = "Defeat 20 magical creatures";
					break;
				case 1:
					dailyKillTarget = 10;
					dailyChallengeDescription = "Defeat 10 enemies in the Forbidden Forest";
					break;
				case 2:
					dailyKillTarget = 5;
					dailyChallengeDescription = "Defeat 5 Dementors or Death Eaters";
					break;
				case 3:
					dailyKillTarget = 15;
					dailyChallengeDescription = "Defeat 15 underground wizard creatures";
					break;
				case 4:
					dailyKillTarget = 30;
					dailyChallengeDescription = "Defeat 30 wizard enemies (any type)";
					break;
			}
		}
		...
		{
			if (dailyCompleted)
				return "Today's challenge is COMPLETE! Come back tomorrow.";

			return $"Daily Challenge: {dailyChallengeDescription} ({dailyKillCount}/{dailyKillTarget})";
		}
			...
			if (dailyKillCount >= dailyKillTarget)
			{
				...
				foreach (var player in Main.ActivePlayers)
				{
					...
					if (player.whoAmI == Main.myPlayer)
						Main.NewText(Language.GetTextValue("Mods.WizardingWorld.DailyChallenge.Complete"), 255, 215, 0);
				}
			}
		}
	}
