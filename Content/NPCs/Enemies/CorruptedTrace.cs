...
{
    /// <summary>Corrupted Trace -- dark taint in the Unicorn Glade. Cleanse by destroying. NOT a unicorn. Mod-original.</summary>
    public class CorruptedTrace : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(3))
            {
                Dust d = Dust.NewDustDirect(NPC.position, NPC.width, NPC.height,
                    DustID.Shadowflame, 0f, -0.5f, 100, default, 0.7f);
                d.noGravity = true;
            }
        }
        ...
        public override void OnKill()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                Dust d = Dust.NewDustDirect(NPC.Center, 4, 4, DustID.GreenTorch,
